...
async function main() {
  ...
  if (!directDatabaseUrl) {
    console.error('[import-all-v3] DIRECT_DATABASE_URL is required. No database operation was performed.');
    process.exit(1);
  }
      ...
      try {
        ...
        await client.query(
          `
            ...
            ("materialId", type, quantity, "beforeQty", "afterQty", "related_doc", remark, created_at)
